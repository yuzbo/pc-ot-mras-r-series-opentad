...
def test_metadata_position_source_selected_times_sort_jitter_repairs_nonmonotonic():
    ...
    assert int(aux["selected_dense_position_pre_repair_strict_violation_count"].item()) > 0
    assert int(aux["selected_dense_position_jitter_repair_count"].item()) > 0
    assert int(aux["selected_dense_position_strict_violation_count"].item()) == 0
