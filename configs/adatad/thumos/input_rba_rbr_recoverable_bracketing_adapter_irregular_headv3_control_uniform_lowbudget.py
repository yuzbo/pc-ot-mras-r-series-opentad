_base_ = ["./input_rba_rbr_recoverable_bracketing_adapter_irregular_headv3_control_uniform_full.py"]
...
work_dir = "exps/thumos/adatad/input_rba_rbr_recoverable_bracketing_adapter_irregular_headv3_control_uniform_lowbudget_shortdiag_only"
