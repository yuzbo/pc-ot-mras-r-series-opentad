...
stage_id = "c3_hybrid_reader_candidate_n16r4"
...
experiment_scope = dict(
    ...
    boundary_lock=(
        "C3-Hybrid keeps the C3 fixed 384 over dense 768 frame-level protocol "
        "and changes only the scout reader family toward local-temporal plus slot-query scoring."
    ),
    ...
    selector_reader="PCOTMRASHybridFrameScout",
...
work_dir = "exps/thumos/adatad/pc_ot_mras_prebackbone_c3_hybrid_reader_candidate_n16r4"
