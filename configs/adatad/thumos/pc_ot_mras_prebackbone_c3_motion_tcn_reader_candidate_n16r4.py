...
stage_id = "c3_motion_tcn_reader_candidate_n16r4"
...
experiment_scope = dict(
    ...
    boundary_lock=(
        "C3-Motion-TCN keeps the C3 fixed 384 over dense 768 frame-level protocol "
        "and changes only the scout reader family toward motion-aware temporal TCN scoring."
    ),
    ...
    selector_reader="PCOTMRASMotionTCNFrameScout",
...
model = dict(
    frame_selector=dict(
        ...
        reader=dict(
            _delete_=True,
            type="PCOTMRASMotionTCNFrameScout",
...
work_dir = "exps/thumos/adatad/pc_ot_mras_prebackbone_c3_motion_tcn_reader_candidate_n16r4"
