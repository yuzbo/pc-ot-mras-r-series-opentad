...
# C3 eval-time ablation only: keep R18 checkpoint/eval protocol and local
...
work_dir = "exps/thumos/adatad/ctf_bdi_pc_ot_mras_r18_c3_no_gate_scale_eval_local_lowmem_candidate"
