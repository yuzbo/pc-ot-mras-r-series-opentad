...
# R17 post-training evaluation candidate.
# This config intentionally opens only the completed-checkpoint tools/test.py
# path. It keeps the formal R17 model topology unchanged and must be launched
# through the dedicated post-train eval launcher with checkpoint/source/data
# evidence bound by the entrypoint gate.

r17_pc_ot_mras_formal_train_gate = None

r17_pc_ot_mras_post_train_eval_gate = dict(
    route="CTF-BDI/PC-OT-MRAS",
    stage="R17_post_train_eval_candidate",
    reviewed_predecessor="R17_formal_train_candidate",
    default_off=True,
    ...
    entrypoint_gate_context=dict(
        ...
        allowed_decisions=("ALLOW_R17_POST_TRAIN_EVAL",),
        forbidden_true_keys=(
            "tools_train",
            "direct_tools_train",
...
work_dir = "exps/thumos/adatad/ctf_bdi_pc_ot_mras_r17_post_train_eval_candidate"
