...
# R18 completed-checkpoint reader-disabled evaluation candidate.
# The train-only auxiliary surface remains loadable, but eval-time reader
# selection is replaced by a deterministic exact-uniform payload.

r18_pc_ot_mras_post_train_eval_gate = None

r18_pc_ot_mras_reader_disabled_eval_gate = dict(
    route="CTF-BDI/PC-OT-MRAS",
    stage="R18_reader_disabled_eval_candidate",
    reviewed_predecessor="R18_post_train_eval_candidate",
    default_off=True,
    ...
    entrypoint_gate_context=dict(
        ...
        allowed_decisions=("ALLOW_R18_READER_DISABLED_EVAL",),
        forbidden_true_keys=(
            "tools_train",
            "direct_tools_train",
...
work_dir = "exps/thumos/adatad/ctf_bdi_pc_ot_mras_r18_reader_disabled_eval_candidate"
