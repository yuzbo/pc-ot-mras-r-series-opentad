...
# C3 oracle-shell indirect PRECHECK launcher for N16R4 GPU1 inside protected parent hold 1118197.
...
CONFIG="configs/adatad/thumos/c3_oracle_shell_indirect_precheck.py"
...
export MASTER_PORT="${MASTER_PORT:-${C3_ORACLE_SHELL_INDIRECT_MASTER_PORT:-30041}}"
